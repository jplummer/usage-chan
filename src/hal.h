...
// There is no "off". Level 0 is a dark backlight and brightness is persisted, so
// a stored 0 boots dark forever with no visible way back — and a screen you
// cannot see is not doing its job on a desk device.
